...
router.get('/staff/profile',auth.reqAuth, auth.CheckRole, StaffController.Staff_Profile)
router.get('/Faculty/subject/:faculty_id', auth.reqAuth, auth.CheckRole, StaffController.Subject_Page)
